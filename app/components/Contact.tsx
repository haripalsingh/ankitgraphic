      ...
      <div className="max-w-7xl mx-auto   border-l border-r border-blue-500">
        <div className="grid grid-cols-1 md:grid-cols-12 ">
          ...
          <div className="col-span-1 md:col-span-6">
            <div className="grid grid-cols-1 md:grid-cols-12 ">
              {/* Left Arrow */}
              <div className="col-span-1 md:col-span-12 border-l border-blue-500">
             ...
             py-3 transition-all duration-300 text-center"
                    ...
                    <div className="w-1/4 text-center border-l border-blue-500">
                      {" "}
                    <Link
                      href="#"
                      className="group 
             ...
             py-3 transition-all duration-300 "
                    >
                      <svg
                        className="w-24 h-24 text-blue-600 inline-block"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg"
                      >
